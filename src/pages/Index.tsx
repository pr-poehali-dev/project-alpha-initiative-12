    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 w-full bg-background/80 backdrop-blur-2xl border-b border-accent/20 z-50">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div className="font-display font-bold text-xl tracking-tight bg-gradient-to-r from-white via-accent to-accent/80 bg-clip-text text-transparent">
              Разумный выбор
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button className="px-5 py-2.5 text-sm font-medium bg-gradient-to-r from-accent to-accent/80 text-white rounded-full hover:shadow-lg hover:shadow-accent/40 transition-all font-semibold">
              Попробовать
            </button>
          </div>
        </div>
      ...
      <section id="hero" className="relative pt-32 pb-32 px-6 min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 w-full h-full flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-accent/20 via-purple-900/10 to-blue-900/20" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="mb-8 inline-block">
                <span className="text-xs font-medium tracking-widest text-accent/80 uppercase">
                  Образовательное приложение для дошкольников с ОВЗ
                </span>
              </div>
              <h1 className="text-6xl lg:text-7xl font-display font-black leading-tight mb-8 tracking-tighter">
                ...
                <br />
                <span className="text-accent">Радуемся!</span>
              </h1>
              <p className="text-xl text-white/80 leading-relaxed mb-10 max-w-xl font-light">
                «Разумный выбор Радионовой» — игровая платформа для развития памяти и внимания у дошкольников с особыми образовательными потребностями. Безопасно, интересно и эффективно.
              </p>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10">
                <div>
                  ...
                  <p className="text-sm text-white/60">Детей уже занимаются</p>
                </div>
                <div>
                  <div className="text-2xl font-bold text-white mb-2">50+</div>
                  <p className="text-sm text-white/60">Развивающих игр</p>
                </div>
                <div>
                  <div className="text-2xl font-bold text-accent mb-2">98%</div>
                  <p className="text-sm text-white/60">Довольных родителей</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-accent/30 via-transparent to-purple-600/20 rounded-3xl blur-3xl animate-pulse" />
          ...
          >
            ...
            <h2 className="text-5xl lg:text-6xl font-display font-black tracking-tighter mt-4 mb-6">
              <span className="bg-gradient-to-r from-white via-white to-accent/40 bg-clip-text text-transparent">
                Всё для развития ребёнка
              </span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Каждая игра разработана с учётом особенностей детей с ОВЗ и одобрена педагогами-дефектологами
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Карточные игры, поиск пар и запоминание последовательностей — прогрессивная нагрузка по уровням сложности",
              },
              {
                icon: "Eye",
                emoji: "👁️",
                title: "Развитие внимания",
                desc: "Найди отличия, лабиринты и задания на концентрацию с яркими визуальными образами",
              },
              {
                icon: "Star",
                emoji: "⭐",
                title: "Система наград",
                desc: "Звёздочки, медали и похвала — каждый маленький успех отмечается и мотивирует двигаться дальше",
              },
              {
                icon: "Shield",
                emoji: "🛡️",
                title: "Безопасный контент",
                desc: "Никакой рекламы, безопасная среда без отвлекающих факторов — только полезные игры",
              },
              {
                icon: "Users",
                emoji: "👨‍👩‍👧",
                title: "Кабинет родителя",
                desc: "Отслеживайте прогресс, время занятий и достижения ребёнка в удобном личном кабинете",
              },
              {
                icon: "Palette",
                emoji: "🎨",
                title: "Адаптивный дизайн",
                desc: "Крупные кнопки, яркие цвета и простой интерфейс — разработан специально для особенных детей",
              },
            ].map((item, i) => {
      ...
      <section id="how" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { num: "01", emoji: "📝", title: "Регистрация", desc: "Создайте аккаунт — это займёт меньше минуты" },
              { num: "02", emoji: "👶", title: "Профиль ребёнка", desc: "Укажите возраст и особенности — подберём подходящие игры" },
              { num: "03", emoji: "🎮", title: "Играем!", desc: "Ребёнок начинает играть, получать звёзды и развиваться" },
              { num: "04", emoji: "📊", title: "Следим за ростом", desc: "Родитель видит прогресс и достижения в личном кабинете" },
            ].map((step, i) => {
            ...
            {[
              {
                ...
                emoji: "👨‍👩‍👧",
                price: "490 ₽/мес",
                desc: "Идеально для домашних занятий",
                features: [
                  "1 профиль ребёнка",
                  "Все базовые игры (30+)",
              ...
              },
              {
                ...
                emoji: "🏫",
                price: "990 ₽/мес",
                desc: "Для специалистов и детских садов",
                features: [
                  "До 20 профилей детей",
                  "Все игры (50+) + новинки",
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {plan.highlight ? "Выбрать тариф" : "Попробовать бесплатно"}
                    </button>
                  </div>
                </div>
              );
      ...
      <section id="cta" className="py-32 px-6">
        ...
        >
          ...
          <h2 className="text-5xl lg:text-6xl font-display font-black tracking-tighter mb-6">
            <span className="bg-gradient-to-r from-white via-white to-accent/40 bg-clip-text text-transparent">
              Дайте ребёнку крылья!
            </span>
          </h2>
          <p className="text-xl text-muted-foreground mb-12 font-light max-w-2xl mx-auto">
            Присоединяйтесь к сотням семей, которые уже помогают своим детям раскрывать потенциал через игру.
          </p>
      ...
      <footer className="border-t border-accent/10 py-12 px-6 bg-background/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <p>© 2026 «Разумный выбор Радионовой» — Игры для развития детей</p>
          </div>
